...
public void deleteBorrower(String id) {
    ...
    try {
        ...
        ps = conn.prepareStatement("DELETE FROM borrower WHERE id = ?");
        ps.setString(1, id);
        ps.executeUpdate();
        conn.close();
        ps.close();
...
public void updateBorrower(Borrower borrower) {
    ...
    try {
        ...
        ps.setDate(3, java.sql.Date.valueOf(borrower.getBorrow_from()));
        ps.setDate(4, java.sql.Date.valueOf(borrower.getBorrow_to()));
